...
if (projectIdText !== undefined && (!Number.isInteger(projectId) || projectId <= 0)) throw new Error('--project-id deve ser um inteiro positivo.');
if (apply && isProductionDatabase(process.env.DATABASE_URL) && !process.argv.includes('--confirm-production')) {
