...
import { projectDeletionService } from '../src/modules/projects/services/project-deletion.service.js';
...
try {
  const report = await projectDeletionService.processDue({ dryRun: !apply });
