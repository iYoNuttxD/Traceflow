...
import { changePasswordBodySchema, forgotBodySchema, loginBodySchema, registerBodySchema, resetBodySchema } from './auth.validation.js';
...
router.post('/forgot-password', validateRequest({ body: forgotBodySchema }), authController.forgotPassword);
router.post('/reset-password', validateRequest({ body: resetBodySchema }), authController.resetPassword);
router.get('/me', authenticate, authController.me);
router.get('/csrf', authenticate, authController.csrf);
router.post('/logout', authenticate, csrf, authController.logout);
router.post('/change-password', authenticate, csrf, validateRequest({ body: changePasswordBodySchema }), authController.changePassword);
