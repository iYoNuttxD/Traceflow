...
router.post('/projects/:projectId/github/sync', validateRequest({ params: githubProjectParamsSchema, body: emptyBodySchema }), githubController.syncProjectGithubArtifacts);
