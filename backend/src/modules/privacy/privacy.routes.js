...
router.delete('/sessions/:sessionId', validateRequest({ params: sessionParams }), privacyController.revokeSession);
router.post('/personal-data/export', privacyController.requestExport);
router.get('/personal-data/export/:exportId', validateRequest({ params: exportParams }), privacyController.exportStatus);
router.get('/personal-data/export/:exportId/download', validateRequest({ params: exportParams }), privacyController.downloadExport);
...
router.post('/deletion-request', validateRequest({ body: passwordBody }), privacyController.requestDeletion);
