...
export const sprintStatusService = {
  async updateSprintStatus(sprintId, status, context = {}) {
    ...
    // A leitura de fora da transacao resolve o 404 cedo. Nada mais: o status que
    // decide a transicao e o relido sob lock (ADR-010 D17). Validar contra este
    // aqui deixava duas requisicoes partirem do mesmo estado, e a segunda reabria
    // o que a primeira encerrou.
