...
export const traceabilityController = {
  ...
  listCommitSuggestions: asyncHandler(
    async (req, res) => {
  ...
  confirmCommitSuggestion: asyncHandler(
    async (req, res) => {
  ...
  rejectCommitSuggestion: asyncHandler(
    async (req, res) => {
  ...
  getRequirementsMatrix: asyncHandler(
    async (req, res) => {
      return res.json(
        await traceabilityService.getRequirementsMatrix(req.params.projectId, req.query)
      );
    },
    { fallbackMessage: 'Erro interno ao carregar matriz de rastreabilidade.' }
  ),

  getRequirementTraceability: asyncHandler(
    async (req, res) => {
  ...
  getTaskTraceability: asyncHandler(
    async (req, res) => {
      return res.json(
        await traceabilityService.getTaskTraceability(
          req.params.projectId,
          req.params.taskId,
          req.query
        )
  ...
  getArtifactTraceability: asyncHandler(
    async (req, res) => {
      return res.json(
        await traceabilityService.getArtifactTraceability(
          req.params.projectId,
