...
Baseline técnico atualizado na E9 em 25/07/2026. Este inventário apoia governança e não constitui conclusão jurídica; base legal, prazos obrigatórios e atendimento formal devem ser validados pelo controlador e assessoria competente.
...
| autoria de commit/login/e-mail | DADO TÉCNICO POTENCIALMENTE PESSOAL | rastreabilidade importada do GitHub por DTO mínimo | `Commit`, `PullRequest`, `Issue` | integrantes do projeto; GitHub é origem/terceiro; RF06 não expõe e-mail de autoria | acompanha artefato técnico | correlação é limitada e não é automaticamente identidade TRACEFLOW |
