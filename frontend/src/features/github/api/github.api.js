...
export const getProjectArtifacts = (projectId, filters = {}, options = {}) => githubApi.artifacts(projectId, filters, options);
export const syncProjectGithub = (projectId) => githubApi.syncProject(projectId);
export const getProjectPullRequests = (projectId, filters = {}, options = {}) => githubApi.pullRequests(projectId, filters, options);
export const getProjectCommits = (projectId, filters = {}, options = {}) => githubApi.commits(projectId, filters, options);
export const getProjectIssues = (projectId, filters = {}, options = {}) => githubApi.issues(projectId, filters, options);
