...
export const tasksApi = {
  list(projectId, params = {}, options = {}) { return httpClient.get(`/projects/${projectId}/tasks`, { ...options, params }); },
...
export const kanbanApi = {
  ...
  listMovements(projectId, params, options = {}) { return httpClient.get(`/projects/${projectId}/kanban/movements`, { ...options, params }); },
  listTaskHistory(projectId, params, options = {}) { return httpClient.get(`/projects/${projectId}/tasks/history`, { ...options, params }); },
  getMetrics(projectId, params, options = {}) { return httpClient.get(`/projects/${projectId}/kanban/metrics`, { ...options, params }); }
};
