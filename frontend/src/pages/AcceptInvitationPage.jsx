...
export function AcceptInvitationPage() {
  ...
  async function accept() { try { const { data } = await authApi.acceptInvitation(params.get('token')); navigate(`/projects/${data.membership.projectId}`); } catch (cause) { setError(normalizeApiError(cause).message); } }
